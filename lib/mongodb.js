...
let bootstrapPromise = global.mongooseBootstrapPromise;
if (!bootstrapPromise) {
  bootstrapPromise = global.mongooseBootstrapPromise = null;
}
...
async function ensureBootstrap() {
  if (!bootstrapPromise) {
    bootstrapPromise = ensureBootstrapData().catch((error) => {
      bootstrapPromise = null;
      global.mongooseBootstrapPromise = null;
      throw error;
    });

    global.mongooseBootstrapPromise = bootstrapPromise;
  }
